...
VALUES(1, 'PVR', '8765432190', 'Bangalore', '583645') ON CONFLICT DO NOTHING;
...
VALUES(1, 'pheonix pvr', 1, '8927177662', 'Bangalore', '560048') ON CONFLICT DO NOTHING;
...
VALUES(1, 'Sushma', 'Hiremath', 'sushma@gmail.com', true) ON CONFLICT DO NOTHING;
INSERT INTO mtbs."user"
(id, first_name, last_name, email, active_status)
VALUES(2, 'Tanisha', 'Swami', 'tanisha@gmail.com', true) ON CONFLICT DO NOTHING;
INSERT INTO mtbs."user"
(id, first_name, last_name, email, active_status)
VALUES(3, 'Nidi', 'singh', 'nidhi@gmail.com', true) ON CONFLICT DO NOTHING;	
